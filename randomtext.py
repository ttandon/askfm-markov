###Based on open source model presented here https://github.com/hrs/markov-sentence-generator
###By http://github.com/hrs

#!/usr/bin/python
##markov model for randomized sentence generation.
import re
import random
import sys
